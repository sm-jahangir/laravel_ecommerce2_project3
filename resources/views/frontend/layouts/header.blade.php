                    ...
                    <div class="row">
                        <div class="menumenu__container clearfix">
                            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-5">
                                <div class="logo">
                                    <a href="{{url('/')}}"><img src="{{ asset('frontend') }}/images/logo/4.png"
                                            alt="logo images"></a>
                                </div>
                            </div>
                                    ...
                                    <ul class="main__menu">
                                        ...
                                        <li class="drop"><a href="#">Pages</a>
                                            <ul class="dropdown">
                                                ...
                                                <li><a href="blog-details.html">Blog Details</a></li>
                                                <li><a href="{{url('/cartlist')}}">Cart page</a></li>
                                                <li><a href="checkout.html">checkout</a></li>
                            ...
                            <div class="col-md-3 col-lg-2 col-sm-4 col-xs-4">
                                <div class="header__right">
                                    ...
                                    <div class="header__account">
                                        @if (Session::has('user'))
                                        {{-- name show koranor jonno --}}
                                        {{-- {{Session::get('user')['name']}} --}}
                                        <a href="/logout"><i class="icon-user icons"></i></a>
                                        @else
                        ...
                        <div class="col-md-12">
                            <div class="search__inner">
                                <form action="{{url('/search')}}" method="get">
                                    <input placeholder="Search here... " name="query" type="text">
                    ...
                    <div class="shp__cart__wrap">
                        <div class="shp__single__product">
                            <div class="shp__pro__thumb">
                                <a href="#">
                                    <img src="{{ asset('frontend') }}/images/product-2/sm-smg/1.jpg"
                                        alt="product images">
                                </a>
                            </div>
                        ...
                        <div class="shp__single__product">
                            <div class="shp__pro__thumb">
                                <a href="#">
                                    <img src="{{ asset('frontend') }}/images/product-2/sm-smg/2.jpg"
                                        alt="product images">
                                </a>
                            </div>
                            <div class="shp__pro__details">
