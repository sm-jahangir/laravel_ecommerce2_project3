...
@section('MainContentFrontend')
    ...
    <div class="ht__bradcaump__area"
        style="background: rgba(0, 0, 0, 0) url({{ asset('frontend') }}/images/bg/4.jpg) no-repeat scroll center center / cover ;">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="contact-form-wrap mt--60">
                        ...
                        <div class="col-xs-12">
                            <form id="contact-form" action="{{url('login/Submit')}}" method="post">
                                {{ csrf_field() }}
